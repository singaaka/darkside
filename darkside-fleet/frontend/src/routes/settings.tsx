...
import { SettingsService } from "@/gen/fleet/v1/api_pb"
    ...
    <div className="space-y-6 max-w-lg">
      ...
      <form onSubmit={save} className="rounded-lg border p-5 space-y-4">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">
            The domain where darkside will be accessible (e.g. <code>darkside.example.com</code>).
      ...
      {settings.data?.darksidePaasNodeId && (
        <div className="rounded-lg border p-4 space-y-1">
          <p className="text-sm font-medium">darkside host node</p>
      ...
      <div className="rounded-lg border bg-muted/30 p-4 space-y-2 text-xs text-muted-foreground">
        <p className="font-medium text-foreground">How darkside-fleet works</p>
