...
import { NodeService, ClusterConfigService } from "@/gen/nm/v1/api_pb"
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            ...
            The first node added is automatically the darkside-paas node.
          </p>
        </div>
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            {node.isDarksidePaasNode && (
              <span className="text-xs bg-primary text-primary-foreground px-1.5 py-0.5 rounded">darkside-paas</span>
            )}
          </div>
